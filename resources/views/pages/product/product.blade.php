...
@section('content')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="productForm" class="form-horizontal" method="post" action="{{ url('/products') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" v-model="form.product_name" class="form-control"
                                        id="product_name" name="product_name" placeholder="โปรดระบุชื่อสินค้า" />
                                </div>
                            </div>
                            <div class="form-group row">
                                        ...
                                        <table class="table table-bordered text-center">
                                            ...
                                            <tbody>
                                                <tr v-if="combinations != ''"
                                                    v-for="(combination, comboIndex) in combinations"
                                                    :key="comboIndex">
                                                    <td>
                                                        <div>
                                                            <p>@{{ combination }}</p>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input v-model="form.Expiry_Date" type="date" class="form-control"
                                        id="Expiry_Date" name="Expiry_Date" placeholder="วันหมดอายุ" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email1"
                            ...
                            <div class="form-group row">
                                <label for="cono1"
                                    class="col-sm-3 text-end control-label col-form-label">น้ำหนัก</label>
                                <div class="col-sm-9">
    ...
    <script>
        ...
        var app = new Vue({
            ...
            methods: {
                // getDynamicModel(index){
                //     console.log(
                //         'feature'+index);
                //     this.form['feature' + index] = this.form.feature0;
                // },
                findSubCategory(id = "") {
