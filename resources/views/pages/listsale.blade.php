                    ...
                    <div class="row">
                        <div class="col-4">
                            <select v-model="selectedCategory" class="form-select">
                                ...
                                <option v-bind:value="category.id" v-for="(category, index) in allCategory"
                                    :key="index">
                        ...
                        <div class="col-4 col-lg-4 col-xl-3 shadow mt-2 mb-1 " v-for="(product,index) in displayedProducts"
                            ...
                            <div class="card">
                                <img :src="product.product_img !== null ? `storage/uploads/${product.product_img}` :
                                    'storage/uploads/no-product.jpeg'"
                                    class="card-img-top" style="width: 100%; height: 150px; object-fit: contain;"
                                    alt="">

                                <div class="card-body">
                                    <h6 class="card-title text-center text-success">@{{ product.product_name }}</h6>
                                    <p class="card-text text-center">@{{ product.product_price != null ? formatPrice(product.product_price)+ ' บาท' : 'สินค้ามีคุณสมบัติ' }} </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr v-if="showVat">
                                        ...
                                        <td colspan="3" class="text-end">@{{ formatPrice(calculatePriceWithVAT(totalCart)) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="row p-2" style="text-align: right;">
                                    ...
                                    <div class="col-7 mb-2">
                                        <input type="text" disabled="disabled"
                                            v-bind:value="formatPrice(currentInput)" class="form-control"
                                    ...
                                    <div class="col-7 mb-2">
                                        <select name="" id="" v-model="choicePayment"
                                            class="form-select" v-on:change="checkStatusPay">
